...
export const Banner = () => {
  ...
  const toRotate = ["Web Developer", "UI/UX Developer", "MERN Stack Developer"];
  const period = 100;
      ...
      <Container>
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={`${isVisible ? "animate__animated animate__fadeIn" : ""} banner-text`}>
                  <span className="tagline">Welcome to my Portfolio</span>
                  <h1>{`Hi! I'm Krishnam`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Web Designer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
